...
import { 
  ArrowLeft, ExternalLink, User, Mail, Calendar, 
  Link as LinkIcon, Palette, Trash2, Package 
} from 'lucide-react';
...
const BundlePreviewPage = () => {
  ...
  const fetchBundleDetail = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:8000/api/admin/bundles/${id}`, {
        headers: {
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
          <div className="text-center bg-white rounded-2xl p-12 shadow-sm border border-gray-200 max-w-md">
            ...
            <p className="text-gray-600 mb-6">
              Bundle dengan ID <code className="bg-gray-100 px-2 py-1 rounded">{id}</code> tidak ditemukan.
            </p>
            <button
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm font-mono">/{bundle.slug}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-gray-900 font-medium">{bundle.user?.name}</p>
              ...
              {bundle.theme && (
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-gray-900 font-medium capitalize">{bundle.theme.name}</p>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div className="text-center bg-purple-50 rounded-xl p-4">
                    <div className="text-4xl font-bold text-purple-600">{bundle.links_count || bundle.links?.length || 0}</div>
              ...
              <div className="flex items-center justify-center">
                <div className="relative">
                  ...
                  <div className="mt-6 flex items-center justify-center gap-3">
                    <a
                      href={`http://localhost:8000/${bundle.slug}`}
                      target="_blank"
                      rel="noopener noreferrer"
